...
/**
 * EvolucionTrasplanteEcografia form.
 *
 ...
 */
class EvolucionTrasplanteEcografiaForm extends BaseEvolucionTrasplanteEcografiaForm
{
  public function configure()
  {
    ...
    $this->widgetSchema['litiasin'] = new sfWidgetFormChoice(array(
                    'expanded' => true,
                    'choices' => datosBasicosHandler::yesOrNoChoicesOptions(),
                ));
  }
