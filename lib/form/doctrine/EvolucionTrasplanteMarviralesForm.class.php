...
/**
 * EvolucionTrasplanteMarvirales form.
 *
 ...
 */
class EvolucionTrasplanteMarviralesForm extends BaseEvolucionTrasplanteMarviralesForm
{
  public function configure()
  {
    ...
    $this->widgetSchema['fecha'] = new sfWidgetFormDate(
        array(
            ...
            'years' => $years));
    $this->widgetSchema['hsv'] = new sfWidgetFormChoice(array(
                    'expanded' => true,
